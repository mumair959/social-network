<template>
   <div class="col-md-8 col-lg-8">
      <div class="card">
         ...
         <div class="card-body">
            <div class="d-flex align-items-center">
               <div class="user-img">
                  <img :src="profile_image" alt="userimg" class="avatar-60 rounded-circle" loading="lazy">
               </div>
               <form class="post-text ms-3 w-100" action="javascript:void();">
                  <input type="text" class="form-control rounded" placeholder="Write Something Here..." style="border:none;" v-model="post.description">
               </form>
            </div>
            <hr>
            <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap pull-right">
               <!-- <li class="me-3 mb-md-0 mb-2">
                  <button class="btn btn-soft-primary">
                     <img src="/assets/images/small/07.png" alt="icon" class="img-fluid me-2" loading="lazy"> Photo/Video
                  </button>
               </li> -->
               <li class="me-3 mb-md-0 mb-2">
                  <button class="btn btn-soft-primary" @click="createPost()">
                     <img src="/assets/images/small/15.png" alt="icon" class="img-fluid me-2 img-size-24" loading="lazy"> Send
                  </button>
               </li>
            </ul>
         </div>
      ...
      <div class="card p-3" v-if="posts.length <= 0">
      ...
      <div v-if="posts.length > 0">
         <div class="card p-3" v-for="p in posts">
...
<script>
    export default {
        mounted() {
            console.log('Profile Friend Request Component mounted.')
        },
        created(){
        ...
        methods: {
            getUserProfileImage() {
                this.isLoading = true;
                axios.get('/get-user-profile-image')
                .then(response => (
